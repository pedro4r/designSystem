...
declare const CheckboxContainer$1: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Checkbox$1.CheckboxProps & react.RefAttributes<HTMLButtonElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
type CheckboxProps = ComponentProps<typeof CheckboxContainer$1>;
...
type CheckboxProps2 = ComponentProps<typeof CheckboxContainer>;
declare function Checkbox2(props: CheckboxProps2): react_jsx_runtime.JSX.Element;
declare namespace Checkbox2 {
    var displayName: string;
}
...
declare const TooltipContent: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Tooltip$1.TooltipContentProps & react.RefAttributes<HTMLDivElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
declare function Tooltip({ trigger, content, ...props }: TooltipProps): react_jsx_runtime.JSX.Element;
...
declare const theme: string & {
    ...
    colors: {
        ...
        jupiter300: _stitches_react_types_theme.Token<"jupiter300", string, "colors", "">;
...
declare const createTheme: <Argument0 extends string | ({
    colors?: {
        ...
        jupiter300?: string | number | boolean | undefined;
